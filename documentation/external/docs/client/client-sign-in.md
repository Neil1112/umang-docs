...
This guide shows the process of signing in a _Client_ account. On Umang Wellness platform, a user is allowed to have multiple roles from _Client_ and _Counsellor_. A user can be have either one or both of the roles.

To sign-in as a _Client_ role, a user should must have registered as a _Client_. To find how to create a Client account, _[click on this link]()_.
